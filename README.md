...
| `--s3-config-file`               | `KMB_S3_CONFIG_FILE`               | `s3-config.json`       | Storage backend configuration file                 |
| `--s3-bucket-name`               | `KMB_S3_BUCKET_NAME`               | `kube-manifest-backup` | Storage bucket/container name                      |
| `--s3-backup-dir`                | `KMB_S3_BACKUP_DIR`                | `target-directory`     | Storage backup directory                           |
